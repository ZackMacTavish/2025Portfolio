...
// Package version of Seo does not import site metadata. Pass siteDefaults if desired.
// Props:
// - title, description, url, images (array of strings or {url,width,height}), image (single), type
// - authorName, authorAlternateNames, sameAs, keywords
// - jsonLd (object), favicons (object or array), siteDefaults (optional: { ogImages, favicons })
const Seo = ({
  title,
  description,
  url,
  ...
  useEffect(() => {
    ...
    // Images handling: prefer provided images, fallback to siteDefaults.ogImages
    ...
    // Favicons: use provided favicons or siteDefaults
