import{j as t}from"./three-D9NkSzoP.js";import{b as q,c as n,u as fe,R as L}from"./vendor-D7aqownG.js";const xe=({title:e,description:i,url:r,image:a,images:s=null,type:d="website",authorName:u="Zack MacTavish",authorAlternateNames:c=["Zachary MacTavish"],sameAs:m=[],keywords:j=[],jsonLd:k=null,favicons:W=null,siteDefaults:g=null,siteName:V=null,locale:Y=null,robots:ee=null,themeColor:te=null,twitterSite:ie=null,twitterCreator:re=null})=>(q.useEffect(()=>{e&&(document.title=e);const h=(o,l,v)=>{let f=document.querySelector(o);if(!f){f=document.createElement("meta");const N=o.match(/\[(name|property)=['"]([^'"]+)['"]\]/);N&&f.setAttribute(N[1],N[2]),document.head.appendChild(f)}f.setAttribute(l,v)};i&&(h("[name='description']","content",i),h("[property='og:description']","content",i),h("[name='twitter:description']","content",i)),j&&j.length&&h("[name='keywords']","content",Array.isArray(j)?j.join(", "):j),e&&(h("[property='og:title']","content",e),h("[name='twitter:title']","content",e)),h("[property='og:type']","content",d),r&&h("[property='og:url']","content",r);const ae=V||g&&g.siteName||null,oe=Y||g&&g.locale||null,ne=ee||g&&g.robots||null,se=te||g&&g.themeColor||null,ce=ie||g&&g.twitterSite||null,de=re||g&&g.twitterCreator||null;ae&&h("[property='og:site_name']","content",ae),oe&&h("[property='og:locale']","content",oe),ne&&h("[name='robots']","content",ne),se&&h("[name='theme-color']","content",se),ce&&h("[name='twitter:site']","content",ce),de&&h("[name='twitter:creator']","content",de);const Pe=g&&g.ogImages||[],Z=s||(a?[a]:null)||Pe,F=o=>{document.querySelectorAll(o).forEach(l=>l.remove())};F("meta[property='og:image']"),F("meta[property='og:image:width']"),F("meta[property='og:image:height']");let D=null;if(Z&&Z.length?Z.forEach(o=>{let l=o;if(typeof o=="string"&&(l={url:o}),!l||!l.url)return;const v=document.createElement("meta");if(v.setAttribute("property","og:image"),v.setAttribute("content",l.url),document.head.appendChild(v),l.width){const f=document.createElement("meta");f.setAttribute("property","og:image:width"),f.setAttribute("content",String(l.width)),document.head.appendChild(f)}if(l.height){const f=document.createElement("meta");f.setAttribute("property","og:image:height"),f.setAttribute("content",String(l.height)),document.head.appendChild(f)}D||(D=l.url)}):a&&(h("[property='og:image']","content",a),D=a),D?(h("[name='twitter:image']","content",D),h("[name='twitter:card']","content","summary_large_image")):h("[name='twitter:card']","content","summary"),r){let o=document.querySelector("link[rel='canonical']");o||(o=document.createElement("link"),o.setAttribute("rel","canonical"),document.head.appendChild(o)),o.setAttribute("href",r)}const le="seo-json-ld";let U=document.getElementById(le);const G={"@context":"https://schema.org","@type":"Person",name:u,url:r||window.location.href};c&&c.length&&(G.alternateName=c.length===1?c[0]:c),m&&m.length&&(G.sameAs=m);let $=k||G;if(!k)$=G;else try{const o=k;(o["@type"]==="CreativeWork"||o["@type"]==="Article")&&!o.author&&(o.author={"@type":"Person",name:u,url:r||window.location.href},c&&c.length&&(o.author.alternateName=c.length===1?c[0]:c),m&&m.length&&(o.author.sameAs=m)),$=o}catch{$=k}if(U?U.text=JSON.stringify($):(U=document.createElement("script"),U.id=le,U.type="application/ld+json",U.text=JSON.stringify($),document.head.appendChild(U)),u||c&&c.length){const o=[u].concat(c||[]).filter(Boolean).join(", ");h("[name='author']","content",o)}m&&m.length&&h("[name='sameAs']","content",m.join(", "));const E=W||g&&g.favicons||null,B=o=>{document.querySelectorAll(`link[rel='${o}']`).forEach(l=>l.remove())};B("icon"),B("shortcut icon"),B("apple-touch-icon"),B("manifest"),E&&(Array.isArray(E)?E.forEach(o=>{const l=document.createElement("link");o.rel?l.setAttribute("rel",o.rel):l.setAttribute("rel",o.sizes==="180x180"?"apple-touch-icon":"icon"),o.sizes&&l.setAttribute("sizes",o.sizes),l.setAttribute("href",o.href),document.head.appendChild(l)}):Object.entries(E).forEach(([o,l])=>{const v=document.createElement("link");o==="180x180"?v.setAttribute("rel","apple-touch-icon"):v.setAttribute("rel","icon"),v.setAttribute("sizes",o),v.setAttribute("href",l),document.head.appendChild(v)}))},[e,i,r,a,d,u,c,m,j,k,W,g,V,Y,ee,te,ie,re]),null);var me={exports:{}},z={},he;function Re(){if(he)return z;he=1;var e=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function r(a,s,d){var u=null;if(d!==void 0&&(u=""+d),s.key!==void 0&&(u=""+s.key),"key"in s){d={};for(var c in s)c!=="key"&&(d[c]=s[c])}else d=s;return s=d.ref,{$$typeof:e,type:a,key:u,ref:s!==void 0?s:null,props:d}}return z.Fragment=i,z.jsx=r,z.jsxs=r,z}var pe;function Ue(){return pe||(pe=1,me.exports=Re()),me.exports}var C=Ue();fe`
