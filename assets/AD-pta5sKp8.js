import{j as e}from"./three-D9NkSzoP.js";import{b as X,c as r,u as he}from"./vendor-D7aqownG.js";import{b as fe}from"./index-OWNjQ_yi.js";const pe=({title:t,description:a,url:n,image:l,images:c=null,type:m="website",authorName:u="Zack MacTavish",authorAlternateNames:o=["Zachary MacTavish"],sameAs:w=[],keywords:y=[],jsonLd:j=null,favicons:G=null,siteDefaults:p=null,siteName:J=null,locale:K=null,robots:Q=null,themeColor:V=null,twitterSite:Y=null,twitterCreator:ee=null})=>(X.useEffect(()=>{t&&(document.title=t);const d=(i,s,v)=>{let x=document.querySelector(i);if(!x){x=document.createElement("meta");const _=i.match(/\[(name|property)=['"]([^'"]+)['"]\]/);_&&x.setAttribute(_[1],_[2]),document.head.appendChild(x)}x.setAttribute(s,v)};a&&(d("[name='description']","content",a),d("[property='og:description']","content",a),d("[name='twitter:description']","content",a)),y&&y.length&&d("[name='keywords']","content",Array.isArray(y)?y.join(", "):y),t&&(d("[property='og:title']","content",t),d("[name='twitter:title']","content",t)),d("[property='og:type']","content",m),n&&d("[property='og:url']","content",n);const te=J||p&&p.siteName||null,ie=K||p&&p.locale||null,re=Q||p&&p.robots||null,ae=V||p&&p.themeColor||null,oe=Y||p&&p.twitterSite||null,ne=ee||p&&p.twitterCreator||null;te&&d("[property='og:site_name']","content",te),ie&&d("[property='og:locale']","content",ie),re&&d("[name='robots']","content",re),ae&&d("[name='theme-color']","content",ae),oe&&d("[name='twitter:site']","content",oe),ne&&d("[name='twitter:creator']","content",ne);const xe=p&&p.ogImages||[],Z=c||(l?[l]:null)||xe,I=i=>{document.querySelectorAll(i).forEach(s=>s.remove())};I("meta[property='og:image']"),I("meta[property='og:image:width']"),I("meta[property='og:image:height']");let P=null;if(Z&&Z.length?Z.forEach(i=>{let s=i;if(typeof i=="string"&&(s={url:i}),!s||!s.url)return;const v=document.createElement("meta");if(v.setAttribute("property","og:image"),v.setAttribute("content",s.url),document.head.appendChild(v),s.width){const x=document.createElement("meta");x.setAttribute("property","og:image:width"),x.setAttribute("content",String(s.width)),document.head.appendChild(x)}if(s.height){const x=document.createElement("meta");x.setAttribute("property","og:image:height"),x.setAttribute("content",String(s.height)),document.head.appendChild(x)}P||(P=s.url)}):l&&(d("[property='og:image']","content",l),P=l),P?(d("[name='twitter:image']","content",P),d("[name='twitter:card']","content","summary_large_image")):d("[name='twitter:card']","content","summary"),n){let i=document.querySelector("link[rel='canonical']");i||(i=document.createElement("link"),i.setAttribute("rel","canonical"),document.head.appendChild(i)),i.setAttribute("href",n)}const se="seo-json-ld";let C=document.getElementById(se);const W={"@context":"https://schema.org","@type":"Person",name:u,url:n||window.location.href};o&&o.length&&(W.alternateName=o.length===1?o[0]:o),w&&w.length&&(W.sameAs=w);let $=j||W;if(!j)$=W;else try{const i=j;(i["@type"]==="CreativeWork"||i["@type"]==="Article")&&!i.author&&(i.author={"@type":"Person",name:u,url:n||window.location.href},o&&o.length&&(i.author.alternateName=o.length===1?o[0]:o),w&&w.length&&(i.author.sameAs=w)),$=i}catch{$=j}if(C?C.text=JSON.stringify($):(C=document.createElement("script"),C.id=se,C.type="application/ld+json",C.text=JSON.stringify($),document.head.appendChild(C)),u||o&&o.length){const i=[u].concat(o||[]).filter(Boolean).join(", ");d("[name='author']","content",i)}w&&w.length&&d("[name='sameAs']","content",w.join(", "));const E=G||p&&p.favicons||null,B=i=>{document.querySelectorAll(`link[rel='${i}']`).forEach(s=>s.remove())};B("icon"),B("shortcut icon"),B("apple-touch-icon"),B("manifest"),E&&(Array.isArray(E)?E.forEach(i=>{const s=document.createElement("link");i.rel?s.setAttribute("rel",i.rel):s.setAttribute("rel",i.sizes==="180x180"?"apple-touch-icon":"icon"),i.sizes&&s.setAttribute("sizes",i.sizes),s.setAttribute("href",i.href),document.head.appendChild(s)}):Object.entries(E).forEach(([i,s])=>{const v=document.createElement("link");i==="180x180"?v.setAttribute("rel","apple-touch-icon"):v.setAttribute("rel","icon"),v.setAttribute("sizes",i),v.setAttribute("href",s),document.head.appendChild(v)}))},[t,a,n,l,m,u,o,w,y,j,G,p,J,K,Q,V,Y,ee]),null);var ce={exports:{}},D={},de;function be(){if(de)return D;de=1;var t=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(l,c,m){var u=null;if(m!==void 0&&(u=""+m),c.key!==void 0&&(u=""+c.key),"key"in c){m={};for(var o in c)o!=="key"&&(m[o]=c[o])}else m=c;return c=m.ref,{$$typeof:t,type:l,key:u,ref:c!==void 0?c:null,props:m}}return D.Fragment=a,D.jsx=n,D.jsxs=n,D}var le;function ve(){return le||(le=1,ce.exports=be()),ce.exports}var L=ve();he`
...
`,f=({src:t,avif:a,webp:n,alt:l="",width:c="60vw",style:m={},responsive:u=!0})=>{typeof t=="string"&&t.split("/").pop().replace(/\.[^.]+$/,"");const o={width:c,maxWidth:"1000px",height:"auto",display:"block",borderRadius:"24px",boxShadow:"0 2px 12px 0 rgba(0,0,0,0.06)",...m};return e.jsxs("picture",{children:[a&&e.jsx("source",{srcSet:a,type:"image/avif"}),n&&e.jsx("source",{srcSet:n,type:"image/webp"}),u&&e.jsx("style",{children:".single-image-responsive { @media (max-width: 1320px) { width: 90vw !important; max-width: 90vw !important; } @media (max-width: 850px) { width: 100vw !important; max-width: 100vw !important; border-radius: 0 !important; } }"}),e.jsx("img",{src:t,alt:l,className:u?"single-image-responsive":void 0,style:o,loading:"lazy",decoding:"async"})]})},b=r.div`
  display: flex;
  justify-content: center;
  background-color: ${t=>t.theme.backgroundTwo};
  align-items: center;
