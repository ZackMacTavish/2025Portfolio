...
`;function A({images:e,autoPlay:i=!1,intervalMs:n=7e3,showControls:o=!0,showDots:a=!0,activeDecoding:d="sync",fixedAspectRatio:s}){const[l,c]=r.useState(0),[m,g]=r.useState(0),[p,h]=r.useState(!1),[u,x]=r.useState(!1),[b,f]=r.useState(!1),[v,w]=r.useState(!1),y=r.useRef(null),$=e.length;r.useEffect(()=>{const e=y.current;if(!e)return;const i=new IntersectionObserver(e=>{var i,t;const r=null!==(i=null===(t=e[0])||void 0===t?void 0:t.isIntersecting)&&void 0!==i&&i;w(r)},{threshold:.8});return i.observe(e),()=>i.disconnect()},[]);const j=e=>{if(!$)return;const i=(e+$)%$;g(l),h(!1),c(i)},A=()=>j(l+1),M=()=>j(l-1);if(r.useEffect(()=>{if(!i||b||$<2||!v)return;const e=setInterval(()=>{c(e=>(g(e),(e+1)%$)),h(!1)},n);return()=>clearInterval(e)},[i,n,b,$,v]),!$)return null;const F=e[l],W=e[m],V=e=>e.objectPosition||("contain"===e.objectFit?"center":"top center");return t.jsxs(k,{children:[t.jsxs(C,{ref:y,$aspectRatio:s||F.aspectRatio||"16 / 9",tabIndex:0,"data-carousel-frame":"true",onMouseEnter:()=>x(!0),onMouseLeave:()=>x(!1),onKeyDown:e=>{"ArrowRight"===e.key&&(e.preventDefault(),f(!0),A()),"ArrowLeft"===e.key&&(e.preventDefault(),f(!0),M())},drag:"x",dragDirectionLock:!0,dragElastic:.16,dragMomentum:!1,dragConstraints:{left:0,right:0},onDragStart:()=>f(!0),onDragEnd:(e,i)=>{var t,r;const n=Math.min(48,.12*(null!==(t=null===(r=y.current)||void 0===r?void 0:r.clientWidth)&&void 0!==t?t:400)),o=i.offset.x+.12*i.velocity.x;o>n?M():o<-n&&A()},children:[t.jsx(S,{$backgroundColor:W.backgroundColor,style:{zIndex:1},children:t.jsx(I,{src:W.src,alt:W.alt,avif:W.avif,webp:W.webp,mobileSrc:W.mobileSrc,mobileAvif:W.mobileAvif,mobileWebp:W.mobileWebp,aspectRatio:W.aspectRatio||"3/2",borderRadius:W.borderRadius||"16px",imageBorderRadius:W.imageBorderRadius,backgroundColor:W.backgroundColor,imagePaddingBlock:W.imagePaddingBlock?`var(--carousel-image-padding-block, ${W.imagePaddingBlock})`:void 0,imagePaddingInline:W.imagePaddingInline?`var(--carousel-image-padding-inline, ${W.imagePaddingInline})`:void 0,objectFit:W.objectFit||"cover",objectPosition:V(W),border:W.containerBorder,disableRevealAnimation:!0,loading:"lazy",decoding:"auto"},`prev-${W.src}-${m}`)}),t.jsx(S,{$backgroundColor:F.backgroundColor,style:{zIndex:2,opacity:p?1:0,transition:"opacity 400ms ease"},children:t.jsx(I,{src:F.src,alt:F.alt,avif:F.avif,webp:F.webp,mobileSrc:F.mobileSrc,mobileAvif:F.mobileAvif,mobileWebp:F.mobileWebp,aspectRatio:F.aspectRatio||"3/2",borderRadius:F.borderRadius||"16px",imageBorderRadius:F.imageBorderRadius,backgroundColor:F.backgroundColor,imagePaddingBlock:F.imagePaddingBlock?`var(--carousel-image-padding-block, ${F.imagePaddingBlock})`:void 0,imagePaddingInline:F.imagePaddingInline?`var(--carousel-image-padding-inline, ${F.imagePaddingInline})`:void 0,objectFit:F.objectFit||"cover",objectPosition:V(F),border:F.containerBorder,disableRevealAnimation:!0,loading:"lazy",decoding:d,onLoad:()=>h(!0)},`active-${F.src}-${l}`)}),$>1&&o&&t.jsxs(R,{$visible:u,children:[t.jsx(z,{type:"button",$side:"left","aria-label":"Previous image",onClick:()=>{f(!0),M()},children:t.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t.jsx("polyline",{points:"15 6 9 12 15 18"})})}),i&&t.jsx(B,{type:"button","aria-label":b?"Resume slideshow":"Pause slideshow",onClick:()=>f(e=>!e),children:b?"▶":"❚❚"}),t.jsx(z,{type:"button",$side:"right","aria-label":"Next image",onClick:()=>{f(!0),A()},children:t.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t.jsx("polyline",{points:"9 6 15 12 9 18"})})})]})]}),$>1&&a&&t.jsx(P,{children:e.map((e,i)=>t.jsx(T,{type:"button",$active:i===l,"aria-label":`Go to slide ${i+1}`,"aria-current":i===l,onClick:()=>{f(!0),j(i)}},`${e.src}-${i}`))})]})}const M=n(g.button)`
  appearance: none;
  background: transparent;
  border: 0;
  padding: 0;
...
`;function Pe({video:e}){var i,n;const o=r.useRef(null),a=m();return r.useEffect(()=>{const i=o.current;if(!i||!e.autoplayOnView||a)return;const t=new IntersectionObserver(([e])=>{e.isIntersecting?i.play().catch(()=>{}):i.pause()},{threshold:.35});return t.observe(i),()=>t.disconnect()},[a,e.autoplayOnView]),t.jsx(Be,{$maxWidth:e.maxWidth,$backgroundColor:e.backgroundColor,$paddingBottom:e.paddingBottom,$paddingInline:e.paddingInline,$border:e.border,children:t.jsx(Se,{$aspectRatio:e.aspectRatio,$backgroundColor:e.backgroundColor,children:t.jsx(Ie,{ref:o,controls:null!==(i=e.controls)&&void 0!==i?i:Boolean(a||!e.autoplayOnView),playsInline:!0,muted:null!==(n=e.muted)&&void 0!==n?n:e.autoplayOnView,loop:e.loop,preload:"metadata",poster:e.poster,"aria-label":e.ariaLabel,$objectFit:e.objectFit,$contentScale:e.contentScale,$contentClipInset:e.contentClipInset,$backgroundColor:e.backgroundColor,children:t.jsx("source",{src:e.src,type:"video/mp4"})})})})}const Te=n.div`
  display: grid;
  grid-template-columns: 1fr;
  gap: 0.75rem;
  align-items: center;
