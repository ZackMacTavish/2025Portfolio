(function(){System.register(["./three-legacy-B14H55ob.js","./vendor-legacy-BOFKzYT_.js","./index-legacy-2Abikzkg.js"],function(Ui,it){"use strict";var e,c,r,fe,we,ve,be,ye,je,l,$e,Ie,Ce,ke,Re,Pe,re,Se,ae,ze,ne,oe,Be,Fe,Ve,Ee,Te,Me,Ae,He,Le,We,Ge,q,X,K,Oe,Ne,_e,De,T,O,N,de,le,se,ee,Qe,Ue,Ye,qe,ce,me,Xe,Ke,Ze,Je,ei,ii,ti,ri,ai,ni,oi,di,li,si,ci,mi,pe,pi,gi,ui,hi,xi,fi,wi,vi,bi,yi,ji,$i,Ii,Ci,ki,Ri,Pi,Si,Z,zi,Bi,Fi,Vi,Ei,Ti,Mi,Ai,Hi,Li,Wi,Gi,Oi,S,k,x,ie,Ni,Yi;function qi(t){const d=we(()=>ve(t)),{isStatic:v}=c.useContext(be);if(v){const[,j]=c.useState(t);c.useEffect(()=>d.on("change",j),[])}return d}function Xi(t,d,{root:v,margin:j,amount:g="some"}={}){const b=ye(t),R=new WeakMap,P=u=>{u.forEach(p=>{const A=R.get(p.target);if(p.isIntersecting!==!!A)if(p.isIntersecting){const H=d(p.target,p);typeof H=="function"?R.set(p.target,H):z.unobserve(p.target)}else typeof A=="function"&&(A(p),R.delete(p.target))})},z=new IntersectionObserver(P,{root:v,rootMargin:j,threshold:typeof g=="number"?g:$e[g]});return b.forEach(u=>z.observe(u)),()=>z.disconnect()}function _i(t,{root:d,margin:v,amount:j,once:g=!1,initial:b=!1}={}){const[R,P]=c.useState(b);return c.useEffect(()=>{if(!t.current||g&&R)return;const z=()=>(P(!0),g?void 0:()=>P(!1)),u={root:d&&d.current||void 0,margin:v,amount:j};return Xi(t.current,z,u)},[d,t,v,g,j]),R}function ge(t){if(!t)return t;try{return encodeURI(decodeURI(t))}catch{return encodeURI(t)}}function F({src:t,alt:d,avif:v,webp:j,aspectRatio:g,parallaxSpeed:b=0,className:R,borderRadius:P="12px",containerBorderRadius:z,backgroundColor:u,imagePaddingBlock:p,objectFit:A="cover",objectPosition:H="center",imageScale:L=1,disableRevealAnimation:_=!1,loading:D="lazy",decoding:y="async",onLoad:Q}){const W=c.useRef(null),U=je(),[$,I]=c.useState(()=>typeof window<"u"&&window.innerWidth<768),m=qi(0);c.useEffect(()=>{if(typeof window>"u")return;const n=()=>{I(window.innerWidth<768)};return n(),window.addEventListener("resize",n),()=>window.removeEventListener("resize",n)},[]);const h=Math.max(0,b)*60,M=b>0&&!U&&!$,C=!!g,V=z??P,he=ge(t),J=ge(v),i=ge(j);return c.useEffect(()=>{if(!M){m.set(0);return}const n=()=>{const a=W.current;if(!a)return;const o=a.getBoundingClientRect(),s=window.innerHeight,w=s+o.height,E=w>0?(s-o.top)/w:.5,f=Math.min(1,Math.max(0,E)),Y=-h+f*h*2;m.set(Y)};return n(),window.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n),()=>{window.removeEventListener("scroll",n),window.removeEventListener("resize",n)}},[h,m,M]),e.jsx(Ie,{ref:W,className:R,$aspectRatio:g,$borderRadius:V,$backgroundColor:u,..._?{}:{initial:{opacity:0,y:24},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.9,ease:[.25,.1,.25,1]}},children:e.jsx(ke,{$imagePaddingBlock:p,$fillContainer:C,$borderRadius:P,children:e.jsxs(Ce,{$fillContainer:C,$borderRadius:P,children:[J&&e.jsx("source",{srcSet:J,type:"image/avif"}),i&&e.jsx("source",{srcSet:i,type:"image/webp"}),e.jsx(Re,{src:he,alt:d,loading:D,decoding:y,onLoad:Q,style:{y:M?m:0,scale:L},$objectFit:A,$objectPosition:H,$hasParallax:M,$fillContainer:C,$borderRadius:P})]})})})}function ue({images:t,autoPlay:d=!1,intervalMs:v=4e3,showControls:j=!0,showDots:g=!0}){c.useEffect(()=>{if(!D.current)return;let m=!1;try{D.current.focus({preventScroll:!0}),m=!0}catch{}},[]);const[b,R]=c.useState(0),[P,z]=c.useState(0),[u,p]=c.useState(!0),[A,H]=c.useState(!1),[L,_]=c.useState(!1),D=c.useRef(null),y=t.length,Q=m=>{if(!y)return;const h=(m+y)%y;z(b),p(!1),R(h)},W=()=>Q(b+1),U=()=>Q(b-1);if(c.useEffect(()=>{if(!d||L||y<2)return;const m=setInterval(()=>{R(h=>(h+1)%y)},v);return()=>clearInterval(m)},[d,v,L,y]),c.useEffect(()=>{if(y<2)return;const m=M=>new Promise(C=>{const V=new Image;V.onload=async()=>{if(typeof V.decode=="function")try{await V.decode()}catch{}C()},V.onerror=()=>C(),V.src=M});(async()=>{const M=t.flatMap(C=>[C.avif,C.webp,C.src].filter(V=>!!V));await Promise.all(M.map(C=>m(C)))})()},[t,y]),!y)return null;const $=t[b],I=t[P];return e.jsxs(Pe,{children:[e.jsxs(re,{ref:D,tabIndex:0,"data-carousel-frame":"true",onMouseEnter:()=>H(!0),onMouseLeave:()=>H(!1),onKeyDown:m=>{m.key==="ArrowRight"&&(m.preventDefault(),_(!0),W()),m.key==="ArrowLeft"&&(m.preventDefault(),_(!0),U())},drag:"x",dragConstraints:{left:0,right:0},onDragEnd:(m,h)=>{h.offset.x>80?U():h.offset.x<-80&&W()},children:[!u&&e.jsx(ne,{style:{zIndex:1},children:e.jsx(oe,{src:I.src,alt:I.alt,avif:I.avif,webp:I.webp,aspectRatio:I.aspectRatio||"3/2",borderRadius:"0",backgroundColor:I.backgroundColor,imagePaddingBlock:I.imagePaddingBlock,objectFit:I.objectFit||"cover",objectPosition:I.objectPosition||"center",disableRevealAnimation:!0,loading:"eager",decoding:"auto"},`prev-${I.src}-${P}`)}),e.jsx(ne,{style:{zIndex:2},children:e.jsx(oe,{src:$.src,alt:$.alt,avif:$.avif,webp:$.webp,aspectRatio:$.aspectRatio||"3/2",borderRadius:"0",backgroundColor:$.backgroundColor,imagePaddingBlock:$.imagePaddingBlock,objectFit:$.objectFit||"cover",objectPosition:$.objectPosition||"center",disableRevealAnimation:!0,loading:"eager",decoding:"auto",onLoad:()=>p(!0),style:{position:u?"relative":"absolute"}},`active-${$.src}-${b}`)}),y>1&&j&&e.jsxs(Se,{$visible:A,children:[e.jsx(ae,{type:"button",$side:"left","aria-label":"Previous image",onClick:U,children:"‹"}),d&&e.jsx(ze,{type:"button","aria-label":L?"Resume slideshow":"Pause slideshow",onClick:()=>_(m=>!m),children:L?"▶":"❚❚"}),e.jsx(ae,{type:"button",$side:"right","aria-label":"Next image",onClick:W,children:"›"})]})]}),y>1&&g&&e.jsx(Be,{children:t.map((m,h)=>e.jsx(Fe,{type:"button",$active:h===b,"aria-label":`Go to slide ${h+1}`,"aria-current":h===b,onClick:()=>Q(h)},`${m.src}-${h}`))})]})}function Ki({tags:t}){const d=c.useRef(null),v=_i(d,{once:!0,margin:"100px"});return e.jsx("div",{ref:d,children:v&&e.jsx(Ci,{children:t.map((j,g)=>e.jsx(l.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.35,delay:g*.04},children:e.jsxs(ki,{children:[j,g<t.length-1&&e.jsx(Ri,{children:"•"})]})},`${j}-${g}`))})})}function Zi({images:t}){const d=c.useRef(null),v=_i(d,{once:!0,margin:"100px"});return e.jsx("div",{ref:d,children:v&&e.jsx(Pi,{children:e.jsx(l.div,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.45},children:e.jsx(ue,{images:t,autoPlay:!0,intervalMs:2800})})})})}return{setters:[function(t){e=t.j},function(t){c=t.b,r=t.c,fe=t.R},function(t){we=t.x,ve=t.y,be=t.M,ye=t.z,je=t.A,l=t.o}],execute:function(){$e={some:0,all:1},Ie=r(l.div)`
  position: relative;
  width: 100%;
  overflow: hidden;
