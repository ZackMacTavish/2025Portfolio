...
`,y=n(g.img)`
  ...
  border-radius: ${e=>e.$borderRadius};
`;function j({src:e,alt:n,avif:o,webp:a,mobileSrc:d,mobileAvif:s,mobileWebp:l,aspectRatio:c,parallaxSpeed:g=0,className:h,borderRadius:p="12px",containerBorderRadius:u,backgroundColor:x,imagePaddingBlock:j,imagePaddingInline:$,objectFit:k="cover",objectPosition:C="center",imageScale:R=1,disableRevealAnimation:z=!1,loading:I="lazy",decoding:S="async",onLoad:P,border:B,mixBlendMode:A}){const F=r.useRef(null),M=m(),[T,W]=r.useState(z||"eager"===I),[L,V]=r.useState(()=>"undefined"!=typeof window&&window.innerWidth<768),E=i(0);r.useEffect(()=>{if("undefined"==typeof window)return;const e=()=>{V(window.innerWidth<768)};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]);const D=60*Math.max(0,g),N=g>0&&!M&&!L,q=Boolean(c),H=null!=u?u:p,O=f(e),Y=f(o),U=f(a),X=f(d),Z=f(s),_=f(l);return r.useEffect(()=>{if(z||!O)return;if("undefined"==typeof window||!window.IntersectionObserver)return;const e=F.current;if(!e)return;const i=new IntersectionObserver(t=>{var r;if(null===(r=t[0])||void 0===r||!r.isIntersecting)return;i.disconnect();const n=e.querySelector("img");if(!n)return void W(!0);const o=()=>{"function"==typeof n.decode?n.decode().then(()=>W(!0)).catch(()=>W(!0)):W(!0)};n.complete?o():(n.onload=o,n.onerror=()=>W(!0))},{rootMargin:"400px 0px"});return i.observe(e),()=>i.disconnect()},[z,O]),r.useEffect(()=>{if(!N)return void E.set(0);const e=()=>{const e=F.current;if(!e)return;const i=e.getBoundingClientRect(),t=window.innerHeight,r=t+i.height,n=r>0?(t-i.top)/r:.5,o=Math.min(1,Math.max(0,n))*D*2-D;E.set(o)};return e(),window.addEventListener("scroll",e,{passive:!0}),window.addEventListener("resize",e),()=>{window.removeEventListener("scroll",e),window.removeEventListener("resize",e)}},[D,E,N]),t.jsx(b,{ref:F,className:h,$aspectRatio:c,$borderRadius:H,$backgroundColor:x,$border:B,...z?{}:{initial:{opacity:0,y:10},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.7,ease:[.25,.1,.25,1]}},children:t.jsx(w,{$imagePaddingBlock:j,$imagePaddingInline:$,$fillContainer:q,$borderRadius:p,children:t.jsxs(v,{$fillContainer:q,$borderRadius:p,children:[Z&&t.jsx("source",{srcSet:Z,type:"image/avif",media:"(max-width: 900px)"}),_&&t.jsx("source",{srcSet:_,type:"image/webp",media:"(max-width: 900px)"}),X&&t.jsx("source",{srcSet:X,media:"(max-width: 900px)"}),Y&&t.jsx("source",{srcSet:Y,type:"image/avif"}),U&&t.jsx("source",{srcSet:U,type:"image/webp"}),t.jsx(y,{src:O,alt:n,loading:I,decoding:S,onLoad:e=>{null==P||P(e)},style:{y:N?E:0,scale:R,mixBlendMode:A,opacity:T?1:0,transition:T?"opacity 0.3s ease":"none"},$objectFit:k,$objectPosition:C,$hasParallax:N,$fillContainer:q,$borderRadius:p})]})})})}const $=n.div`
  width: 100%;
...
`,ci=n.div`
  ...
  width: 100%;
  padding: 0;
  background: ${e=>Z(e.$background,e.theme)||e.theme.surface};
`,mi=n.div`
  position: relative;
  box-sizing: border-box;
  width: 100%;
