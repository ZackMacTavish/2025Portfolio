System.register(["./three-legacy-pzFKRJSU.js","./vendor-legacy-Dy2oZrq6.js","./index-legacy-CsTpLS3N.js"],function(e,i){"use strict";var t,r,n,a,o,d,s,l,c,m,g,p;return{setters:[e=>{t=e.j},e=>{r=e.b,n=e.c,a=e.R,o=e.i},e=>{d=e.u,s=e.a,l=e.M,c=e.r,m=e.b,g=e.m,p=e.A}],execute:function(){function i(e){const i=d(()=>s(e)),{isStatic:t}=r.useContext(l);if(t){const[,t]=r.useState(e);r.useEffect(()=>i.on("change",t),[])}return i}const h={some:0,all:1};function u(e,{root:i,margin:t,amount:n,once:a=!1,initial:o=!1}={}){const[d,s]=r.useState(o);return r.useEffect(()=>{if(!e.current||a&&d)return;const r={root:i&&i.current||void 0,margin:t,amount:n};return function(e,i,{root:t,margin:r,amount:n="some"}={}){const a=c(e),o=new WeakMap,d=new IntersectionObserver(e=>{e.forEach(e=>{const t=o.get(e.target);if(e.isIntersecting!==Boolean(t))if(e.isIntersecting){const t=i(e.target,e);"function"==typeof t?o.set(e.target,t):d.unobserve(e.target)}else"function"==typeof t&&(t(e),o.delete(e.target))})},{root:t,rootMargin:r,threshold:"number"==typeof n?n:h[n]});return a.forEach(e=>d.observe(e)),()=>d.disconnect()}(e.current,()=>(s(!0),a?void 0:()=>s(!1)),r)},[i,e,t,a,n]),d}function x(e){if(!e)return e;try{return encodeURI(decodeURI(e))}catch{return encodeURI(e)}}const f=n(g.div)`
  position: relative;
  width: 100%;
  overflow: hidden;
...
`,H=.18;function Y(e){const i=e.trim();if(i.includes("/")){const[e,t]=i.split("/").map(e=>parseFloat(e));if(e&&t)return e/t}const t=parseFloat(i);return Number.isFinite(t)&&t>0?t:16/9}function q({id:e,className:n,children:a,overlayContent:d,ariaLabel:s="Open image in full-screen viewer",aspectRatio:l="16/9"}){const[c,g]=r.useState(!1),[h,u]=r.useState(!1),x=r.useRef(null),f=m(),b=i(1),w=i(0),v=i(0);r.useEffect(()=>{u(!0)},[]);const j=r.useCallback(()=>{b.set(1),w.set(0),v.set(0)},[b,w,v]),y=r.useCallback(()=>{j(),g(!0)},[j]),$=r.useCallback(()=>{g(!1)},[]);r.useEffect(()=>{if(!c||"undefined"==typeof document)return;const e=document.body.style.overflow;document.body.style.overflow="hidden";const i=e=>{if("Escape"===e.key&&$(),"+"!==e.key&&"="!==e.key||b.set(Math.min(5,b.get()+H)),"-"===e.key||"_"===e.key){const e=Math.max(1,b.get()-H);b.set(e),1===e&&(w.set(0),v.set(0))}"0"===e.key&&j()};return window.addEventListener("keydown",i),()=>{var t;document.body.style.overflow=e,window.removeEventListener("keydown",i),null===(t=x.current)||void 0===t||t.focus()}},[c,$,b,w,v,j]);const k={x:w,y:v,scale:b},R=null!=d?d:a;return t.jsxs(t.Fragment,{children:[t.jsxs(S,{ref:x,type:"button",layoutId:`zoomable-${e}`,className:n,onClick:y,"aria-label":s,style:{visibility:c?"hidden":"visible"},children:[a,t.jsxs(M,{"aria-hidden":"true",children:[t.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("circle",{cx:"11",cy:"11",r:"7"}),t.jsx("line",{x1:"20",y1:"20",x2:"16.65",y2:"16.65"}),t.jsx("line",{x1:"11",y1:"8",x2:"11",y2:"14"}),t.jsx("line",{x1:"8",y1:"11",x2:"14",y2:"11"})]}),"Click to zoom"]})]}),h&&o.createPortal(t.jsx(p,{children:c&&t.jsxs(V,{role:"dialog","aria-modal":"true",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:f?0:.25},onClick:$,children:[t.jsx(L,{type:"button","aria-label":"Close image viewer",onClick:e=>{e.stopPropagation(),$()},children:"×"}),t.jsx(E,{onClick:e=>e.stopPropagation(),onWheel:e=>{e.preventDefault();const i=(e.deltaY>0?-1:1)*H,t=Math.min(5,Math.max(1,b.get()+i));b.set(t),1===t&&(w.set(0),v.set(0))},children:t.jsx(T,{$ratio:Y(l),layoutId:f?void 0:`zoomable-${e}`,style:k,drag:!0,dragMomentum:!1,dragElastic:.08,onDragEnd:()=>{b.get()<=1.001&&(w.set(0),v.set(0))},onDoubleClick:()=>{b.get()>1?j():b.set(2)},transition:{type:"spring",stiffness:260,damping:28},children:R})}),t.jsxs(A,{onClick:e=>e.stopPropagation(),children:[t.jsx(N,{type:"button","aria-label":"Zoom out",onClick:()=>{const e=Math.max(1,b.get()-H);b.set(e),1===e&&(w.set(0),v.set(0))},children:"−"}),t.jsx(N,{type:"button","aria-label":"Reset zoom",onClick:j,children:"⤢"}),t.jsx(N,{type:"button","aria-label":"Zoom in",onClick:()=>{b.set(Math.min(5,b.get()+H))},children:"+"}),t.jsx(W,{}),t.jsx(D,{children:"Scroll to zoom · drag to pan · double-click to reset · Esc to close"})]})]},"zoomable-backdrop")}),document.body)]})}function G({children:e}){const i=r.Children.toArray(e);if(1!==i.length||"string"!=typeof i[0])return t.jsx(t.Fragment,{children:e});const n=i[0],a=n.trim().split(/\s+/);if(a.length<2)return t.jsx(t.Fragment,{children:n});const o=a.pop(),d=a.pop(),s=a.join(" ");return t.jsxs(t.Fragment,{children:[s,s?" ":"",d," ",o]})}const O=new Set(["white","#fff","#ffffff","#fafafa","#f9fafb","#f5f5f5","#f6f8fc","#f0efeb","#e7e7e7","#eeeeee","#eee"]),U=(e,i)=>e?"dark"!==i.name?e:O.has(e.toLowerCase())?i.surface:e:e,X=n.div`
  min-height: 100vh;
...
`,de=e=>{const{children:i,...r}=e;return t.jsx(oe,{...r,children:t.jsx(G,{children:i})})},se=n.div``,le=n.section`
