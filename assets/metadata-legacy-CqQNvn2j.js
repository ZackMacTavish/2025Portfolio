System.register(["./vendor-legacy-Dy2oZrq6.js"],function(e,t){"use strict";var i,o,a;return{setters:[e=>{i=e.b,o=e.c,a=e.u}],execute:function(){e("A",function(e){const{imageSrc:t,imageAvif:i,imageWebp:o,imageAlt:a,mobileSrc:n,mobileAvif:r,mobileWebp:s,width:d,className:h,textSize:y,textColor:f,children:b,...x}=e,w=function e(t){if(!t||"object"!=typeof t)return t;if(Array.isArray(t))return t.map(e);const i={};for(const o in t){if("mobileSrc"===o||"mobileAvif"===o||"mobileWebp"===o)continue;const a=t[o];i[o]="object"==typeof a&&null!==a?e(a):a}return i}(x),v=m(t),k=m(i),$=m(o),C=m(n),A=m(r),M=m(s);return c.jsxs(l,{$width:d,className:h,...w,children:[c.jsx(u,{children:c.jsxs("picture",{children:[A&&c.jsx("source",{srcSet:A,type:"image/avif",media:"(max-width: 700px)"}),M&&c.jsx("source",{srcSet:M,type:"image/webp",media:"(max-width: 700px)"}),C&&c.jsx("source",{srcSet:C,media:"(max-width: 700px)"}),k&&c.jsx("source",{srcSet:k,type:"image/avif"}),$&&c.jsx("source",{srcSet:$,type:"image/webp"}),c.jsx(p,{src:v,alt:a})]})}),c.jsx(g,{$textSize:y,$textColor:f,children:b})]})}),e("E",({title:e,description:t,url:o,image:a,images:n=null,type:r="website",authorName:s="Zack MacTavish",authorAlternateNames:c=["Zachary MacTavish"],sameAs:d=[],keywords:l=[],jsonLd:u=null,favicons:p=null,siteDefaults:g=null,siteName:m=null,locale:h=null,robots:y=null,themeColor:f=null,twitterSite:b=null,twitterCreator:x=null})=>(i.useEffect(()=>{e&&(document.title=e);const i=(e,t,i)=>{let o=document.querySelector(e);if(!o){o=document.createElement("meta");const t=e.match(/\[(name|property)=['"]([^'"]+)['"]\]/);t&&o.setAttribute(t[1],t[2]),document.head.appendChild(o)}o.setAttribute(t,i)};t&&(i("[name='description']","content",t),i("[property='og:description']","content",t),i("[name='twitter:description']","content",t)),l&&l.length&&i("[name='keywords']","content",Array.isArray(l)?l.join(", "):l),e&&(i("[property='og:title']","content",e),i("[name='twitter:title']","content",e)),i("[property='og:type']","content",r),o&&i("[property='og:url']","content",o);const w=m||g&&g.siteName||null,v=h||g&&g.locale||null,k=y||g&&g.robots||null,$=f||g&&g.themeColor||null,C=b||g&&g.twitterSite||null,A=x||g&&g.twitterCreator||null;w&&i("[property='og:site_name']","content",w),v&&i("[property='og:locale']","content",v),k&&i("[name='robots']","content",k),$&&i("[name='theme-color']","content",$),C&&i("[name='twitter:site']","content",C),A&&i("[name='twitter:creator']","content",A);const M=g&&g.ogImages||[],j=n||(a?[a]:null)||M,S=e=>{document.querySelectorAll(e).forEach(e=>e.remove())};S("meta[property='og:image']"),S("meta[property='og:image:width']"),S("meta[property='og:image:height']");let T=null;if(j&&j.length?j.forEach(e=>{let t=e;if("string"==typeof e&&(t={url:e}),!t||!t.url)return;const i=document.createElement("meta");if(i.setAttribute("property","og:image"),i.setAttribute("content",t.url),document.head.appendChild(i),t.width){const e=document.createElement("meta");e.setAttribute("property","og:image:width"),e.setAttribute("content",String(t.width)),document.head.appendChild(e)}if(t.height){const e=document.createElement("meta");e.setAttribute("property","og:image:height"),e.setAttribute("content",String(t.height)),document.head.appendChild(e)}T||(T=t.url)}):a&&(i("[property='og:image']","content",a),T=a),T?(i("[name='twitter:image']","content",T),i("[name='twitter:card']","content","summary_large_image")):i("[name='twitter:card']","content","summary"),o){let e=document.querySelector("link[rel='canonical']");e||(e=document.createElement("link"),e.setAttribute("rel","canonical"),document.head.appendChild(e)),e.setAttribute("href",o)}const Z="seo-json-ld";let I=document.getElementById(Z);const P={"@context":"https://schema.org","@type":"Person",name:s,url:o||window.location.href};c&&c.length&&(P.alternateName=1===c.length?c[0]:c),d&&d.length&&(P.sameAs=d);let U=u||P;if(u)try{const e=u;("CreativeWork"===e["@type"]||"Article"===e["@type"])&&!e.author&&(e.author={"@type":"Person",name:s,url:o||window.location.href},c&&c.length&&(e.author.alternateName=1===c.length?c[0]:c),d&&d.length&&(e.author.sameAs=d)),U=e}catch{U=u}else U=P;I?I.text=JSON.stringify(U):(I=document.createElement("script"),I.id=Z,I.type="application/ld+json",I.text=JSON.stringify(U),document.head.appendChild(I)),(s||c&&c.length)&&i("[name='author']","content",[s].concat(c||[]).filter(Boolean).join(", ")),d&&d.length&&i("[name='sameAs']","content",d.join(", "));const E=p||g&&g.favicons||null,z=e=>{document.querySelectorAll(`link[rel='${e}']`).forEach(e=>e.remove())};z("icon"),z("shortcut icon"),z("apple-touch-icon"),z("manifest"),E&&(Array.isArray(E)?E.forEach(e=>{const t=document.createElement("link");e.rel?t.setAttribute("rel",e.rel):t.setAttribute("rel","180x180"===e.sizes?"apple-touch-icon":"icon"),e.sizes&&t.setAttribute("sizes",e.sizes),t.setAttribute("href",e.href),document.head.appendChild(t)}):Object.entries(E).forEach(([e,t])=>{const i=document.createElement("link");"180x180"===e?i.setAttribute("rel","apple-touch-icon"):i.setAttribute("rel","icon"),i.setAttribute("sizes",e),i.setAttribute("href",t),document.head.appendChild(i)}))},[e,t,o,a,r,s,c,d,l,u,p,g,m,h,y,f,b,x]),null));var t,n,r={exports:{}},s={},c=(n||(n=1,r.exports=function(){if(t)return s;t=1;var e=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function o(t,i,o){var a=null;if(void 0!==o&&(a=""+o),void 0!==i.key&&(a=""+i.key),"key"in i)for(var n in o={},i)"key"!==n&&(o[n]=i[n]);else o=i;return i=o.ref,{$$typeof:e,type:t,key:a,ref:void 0!==i?i:null,props:o}}return s.Fragment=i,s.jsx=o,s.jsxs=o,s}()),r.exports);a`
