System.register(["./vendor-legacy-BmQ_CjD0.js"],function(i,e){"use strict";var t;return{setters:[i=>{t=i.c}],execute:function(){i("f",t.a`
  display: inline-flex;
  align-items: center;
  gap: 0.32em;
  background: #111;
...
`,i("R",t.img.attrs({loading:"lazy",decoding:"async"})`
  width: 60vw;
