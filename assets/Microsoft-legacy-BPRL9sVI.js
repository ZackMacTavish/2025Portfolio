...
`;function le({imageBaseName:e=null,imageSrc:i="",imageAvif:a=null,imageWebp:n=null,imageAlt:r="",$imageWidth:o="38vw",buttons:s=[],divider:d=!0,imageExt:c="jpg",title:m="",imageNaturalWidth:l=null,imageNaturalHeight:h=null,invertOnDark:g=!1}){const u=e?`${e.startsWith("assets/")?"/":"/src/"}${e}`:null,x=u?te(`${u}.avif`):null,f=u?te(`${u}.webp`):null,y=u?te(`${u}.${c||"jpg"}`):null,b=Math.max(l||0,h||0)>900,j=b?p(x):null,v=b?p(f):null,k=b?p(y):null;return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"mobile-nav-spacer",style:{display:"block",width:"100%",height:"12vh",minHeight:0,padding:0,margin:0,background:"transparent",zIndex:0,pointerEvents:"none",position:"relative"}}),t.jsxs(ae,{className:"first",children:[t.jsxs(ne,{children:[t.jsx(de,{children:m}),d&&t.jsx(ce,{}),t.jsx(me,{children:s.map(({href:e,label:i},a)=>t.jsxs(w,{href:e,target:"_blank",rel:"noopener noreferrer",children:[i," ",t.jsx(z,{style:{marginLeft:6,fontSize:"1.2em"}})]},a))})]}),t.jsx(re,{children:e?t.jsxs(oe,{children:[j&&t.jsx("source",{srcSet:j,type:"image/avif",media:"(max-width: 900px)"}),t.jsx("source",{srcSet:x,type:"image/avif"}),v&&t.jsx("source",{srcSet:v,type:"image/webp",media:"(max-width: 900px)"}),t.jsx("source",{srcSet:f,type:"image/webp"}),k&&t.jsx("source",{srcSet:k,media:"(max-width: 900px)"}),t.jsx(se,{src:y,alt:r,$imageWidth:o,$invertOnDark:g,$naturalWidth:l||void 0,$naturalHeight:h||void 0,width:l||void 0,height:h||void 0,fetchPriority:"high",loading:"eager",decoding:"sync"})]}):t.jsx(se,{src:te(i),alt:r,$imageWidth:o,width:l||void 0,height:h||void 0,fetchPriority:"high",loading:"eager",decoding:"async"})})]})]})}function pe(e){try{return encodeURI(decodeURI(e))}catch{return encodeURI(e)}}const he=n.section`
