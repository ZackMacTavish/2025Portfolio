...
`,w=a.img`
  ...
  @media (max-width: 850px) {
    ...
    margin-bottom: 0;
    object-fit: contain;
    border-radius: ${e=>e.$fillTile?"0":"18px"};
  }
`,b=a.h1`
