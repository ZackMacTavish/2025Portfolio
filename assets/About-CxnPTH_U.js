import{j as e}from"./three-DujNlRV8.js";import{c as i,b as r,l as m}from"./vendor-DcaHsDtB.js";import w from"./three-BUeX2W-Q.js";import{a as p,p as s,s as x,m as f,F as u,T as v,b,q as y,i as j}from"./index-bbeB7ukB.js";const k=i.div`
  display: flex;
  align-items: center;
...
`,F=i.div`
  ...
  grid-column-start: 3;
  grid-row-start: 2;
`,B=()=>{const[t,l]=r.useState(!0),[n,h]=r.useState(!1),[c,g]=r.useState(window.innerWidth>450);return r.useLayoutEffect(()=>{window.scrollTo(0,0)},[]),r.useEffect(()=>{const o=()=>{!n&&window.scrollY>50&&(l(!1),h(!0))};window.addEventListener("scroll",o);const a=()=>g(window.innerWidth>450);return window.addEventListener("resize",a),()=>{window.removeEventListener("scroll",o),window.removeEventListener("resize",a)}},[n]),e.jsxs("div",{children:[e.jsx(p,{...s.about,sameAs:x.sameAs,keywords:s.about.keywords}),e.jsxs(k,{Backgroundheight:"100vh",style:{position:"relative"},children:[e.jsx(I,{src:f}),e.jsx(d,{Widthsize:"47vw",children:"Hi, I'm Zack MacTavish, an artist and product designer based in Philadelphia, PA. For the past three years, I've been with Microsoft's Shopping Team, shaping user experiences for digital products."}),!n&&e.jsx(S,{visible:t,children:e.jsx(T,{})})]}),e.jsx(u,{style:{backgroundColor:"white"},children:e.jsx(v,{children:e.jsxs(b,{style:{color:"#5d5d5d"},children:["Some of the agencies I have worked with include"," ",e.jsx("a",{href:"https://www.publicisgroupe.com/en",target:"_blank",rel:"noopener noreferrer",style:{color:"#5d5d5d",textDecoration:"underline"},children:"Publicis Groupe"}),","," ",e.jsx("a",{href:"https://prairieandforge.com/",target:"_blank",rel:"noopener noreferrer",style:{color:"#5d5d5d",textDecoration:"underline"},children:"Prairie & Forge"}),", and"," ",e.jsx("a",{href:"https://varfaj.com/",target:"_blank",rel:"noopener noreferrer",style:{color:"#5d5d5d",textDecoration:"underline"},children:"Varfaj Partners"}),". I've also lived in New York City, working as a graphic designer in Manhattan for"," ",e.jsx("a",{href:"https://www.outsourceconsultants.com/",target:"_blank",rel:"noopener noreferrer",style:{color:"#5d5d5d",textDecoration:"underline"},children:"Outsource Consultants"}),", and studied design in Chicago. I've collaborated with clients such as Microsoft, Walmart, Seagate Technology on Disney-branded products, and Chip Ganassi Racing."]})})}),e.jsx(A,{children:e.jsxs(C,{children:[e.jsx(D,{src:y,alt:"Quilt hanging"}),e.jsx(E,{children:"Outside of work, I live with my partner Olivia, who is also an artist. In my own creative time, I focus on making quilts that combine photography, textile techniques, and mixed media, exploring the intersection of art, design, and storytelling."})]})}),e.jsx($,{children:e.jsxs(G,{children:[e.jsxs(P,{children:["Thanks for ",e.jsx("br",{}),"stopping by"]}),e.jsx(F,{children:c?e.jsx(w,{}):e.jsx("img",{style:{width:"90vw"},src:j,alt:"fallback"})})]})})]})};export{q as NewSection,A as QuiltContainer,D as QuiltImage,C as QuiltInner,E as QuiltText,B as default};
