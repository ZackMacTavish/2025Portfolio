import{j as e}from"./three-D9NkSzoP.js";import{b as X,c as r,u as he}from"./vendor-D7aqownG.js";import{b as fe}from"./index-OWNjQ_yi.js";const pe=({title:t,description:a,url:o,image:m,images:c=null,type:h="website",authorName:u="Zack MacTavish",authorAlternateNames:n=["Zachary MacTavish"],sameAs:w=[],keywords:j=[],jsonLd:k=null,favicons:G=null,siteDefaults:p=null,siteName:J=null,locale:K=null,robots:Q=null,themeColor:V=null,twitterSite:Y=null,twitterCreator:ee=null})=>(X.useEffect(()=>{t&&(document.title=t);const d=(i,s,v)=>{let x=document.querySelector(i);if(!x){x=document.createElement("meta");const _=i.match(/\[(name|property)=['"]([^'"]+)['"]\]/);_&&x.setAttribute(_[1],_[2]),document.head.appendChild(x)}x.setAttribute(s,v)};a&&(d("[name='description']","content",a),d("[property='og:description']","content",a),d("[name='twitter:description']","content",a)),j&&j.length&&d("[name='keywords']","content",Array.isArray(j)?j.join(", "):j),t&&(d("[property='og:title']","content",t),d("[name='twitter:title']","content",t)),d("[property='og:type']","content",h),o&&d("[property='og:url']","content",o);const te=J||p&&p.siteName||null,ie=K||p&&p.locale||null,re=Q||p&&p.robots||null,ae=V||p&&p.themeColor||null,oe=Y||p&&p.twitterSite||null,ne=ee||p&&p.twitterCreator||null;te&&d("[property='og:site_name']","content",te),ie&&d("[property='og:locale']","content",ie),re&&d("[name='robots']","content",re),ae&&d("[name='theme-color']","content",ae),oe&&d("[name='twitter:site']","content",oe),ne&&d("[name='twitter:creator']","content",ne);const xe=p&&p.ogImages||[],Z=c||(m?[m]:null)||xe,I=i=>{document.querySelectorAll(i).forEach(s=>s.remove())};I("meta[property='og:image']"),I("meta[property='og:image:width']"),I("meta[property='og:image:height']");let P=null;if(Z&&Z.length?Z.forEach(i=>{let s=i;if(typeof i=="string"&&(s={url:i}),!s||!s.url)return;const v=document.createElement("meta");if(v.setAttribute("property","og:image"),v.setAttribute("content",s.url),document.head.appendChild(v),s.width){const x=document.createElement("meta");x.setAttribute("property","og:image:width"),x.setAttribute("content",String(s.width)),document.head.appendChild(x)}if(s.height){const x=document.createElement("meta");x.setAttribute("property","og:image:height"),x.setAttribute("content",String(s.height)),document.head.appendChild(x)}P||(P=s.url)}):m&&(d("[property='og:image']","content",m),P=m),P?(d("[name='twitter:image']","content",P),d("[name='twitter:card']","content","summary_large_image")):d("[name='twitter:card']","content","summary"),o){let i=document.querySelector("link[rel='canonical']");i||(i=document.createElement("link"),i.setAttribute("rel","canonical"),document.head.appendChild(i)),i.setAttribute("href",o)}const se="seo-json-ld";let C=document.getElementById(se);const W={"@context":"https://schema.org","@type":"Person",name:u,url:o||window.location.href};n&&n.length&&(W.alternateName=n.length===1?n[0]:n),w&&w.length&&(W.sameAs=w);let $=k||W;if(!k)$=W;else try{const i=k;(i["@type"]==="CreativeWork"||i["@type"]==="Article")&&!i.author&&(i.author={"@type":"Person",name:u,url:o||window.location.href},n&&n.length&&(i.author.alternateName=n.length===1?n[0]:n),w&&w.length&&(i.author.sameAs=w)),$=i}catch{$=k}if(C?C.text=JSON.stringify($):(C=document.createElement("script"),C.id=se,C.type="application/ld+json",C.text=JSON.stringify($),document.head.appendChild(C)),u||n&&n.length){const i=[u].concat(n||[]).filter(Boolean).join(", ");d("[name='author']","content",i)}w&&w.length&&d("[name='sameAs']","content",w.join(", "));const E=G||p&&p.favicons||null,B=i=>{document.querySelectorAll(`link[rel='${i}']`).forEach(s=>s.remove())};B("icon"),B("shortcut icon"),B("apple-touch-icon"),B("manifest"),E&&(Array.isArray(E)?E.forEach(i=>{const s=document.createElement("link");i.rel?s.setAttribute("rel",i.rel):s.setAttribute("rel",i.sizes==="180x180"?"apple-touch-icon":"icon"),i.sizes&&s.setAttribute("sizes",i.sizes),s.setAttribute("href",i.href),document.head.appendChild(s)}):Object.entries(E).forEach(([i,s])=>{const v=document.createElement("link");i==="180x180"?v.setAttribute("rel","apple-touch-icon"):v.setAttribute("rel","icon"),v.setAttribute("sizes",i),v.setAttribute("href",s),document.head.appendChild(v)}))},[t,a,o,m,h,u,n,w,j,k,G,p,J,K,Q,V,Y,ee]),null);var ce={exports:{}},D={},de;function be(){if(de)return D;de=1;var t=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function o(m,c,h){var u=null;if(h!==void 0&&(u=""+h),c.key!==void 0&&(u=""+c.key),"key"in c){h={};for(var n in c)n!=="key"&&(h[n]=c[n])}else h=c;return c=h.ref,{$$typeof:t,type:m,key:u,ref:c!==void 0?c:null,props:h}}return D.Fragment=a,D.jsx=o,D.jsxs=o,D}var le;function ve(){return le||(le=1,ce.exports=be()),ce.exports}var L=ve();he`
...
`;function Kt({imageSrc:t,imageAvif:a,imageWebp:o,imageAlt:m,children:c,imageWidth:h,columns:u,width:n,textSize:w,textColor:j,className:k,...G}){return L.jsxs(je,{$width:n,className:k,...G,children:[L.jsx(ke,{children:L.jsxs("picture",{children:[a&&L.jsx("source",{srcSet:a,type:"image/avif"}),o&&L.jsx("source",{srcSet:o,type:"image/webp"}),L.jsx(Ae,{src:t,alt:m})]})}),L.jsx(Re,{$textSize:w,$textColor:j,children:c})]})}const l="https://mactavish.xyz",y={name:"Zack MacTavish",url:l,defaultImage:`${l}/assets/og/website-logoresolutions-1200x630.png`,sameAs:["https://dribbble.com/Zmactavish","https://www.instagram.com/zackmichaelmactavish","https://www.linkedin.com/in/zacharymactavish/","https://github.com/ZackMacTavish","https://medium.com/@zmactavish"],keywords:["product design","graphic design","UX","portfolio","Zack MacTavish"]},g={landing:{title:`${y.name} — Product & Graphic Designer`,description:"Product & graphic designer focused on brand, UX, and digital experiences. View work and contact.",url:`${l}/`,image:y.defaultImage,keywords:["portfolio","home","design","Zack MacTavish"]},about:{title:`About — ${y.name}`,description:"About Zack MacTavish — product & graphic designer. Learn about my background, work, and exhibitions.",url:`${l}/about`,image:y.defaultImage,keywords:["about","bio","background"]},giga:{title:"Giga — UX/UI & Branding | Zack MacTavish",description:"Case study: Giga — UX/UI, branding, and product design by Zack MacTavish.",url:`${l}/projects/giga`,image:`${l}/assets/Giga—Macbookv2.png`,datePublished:"2024-10-01",keywords:["giga","product design","ux","branding"]},outsource:{title:"Outsource — UX/UI & Branding | Zack MacTavish",description:"Case study: Outsource — branding, websites and UX work by Zack MacTavish.",url:`${l}/projects/outsource`,image:`${l}/assets/Outsource—Macbook.png`,datePublished:"2023-08-01",keywords:["outsource","branding","ux"]},piton:{title:"Piton — Project | Zack MacTavish",description:"Case study: Piton — UX and visual design work by Zack MacTavish.",url:`${l}/projects/piton`,image:`${l}/assets/Piton—Screens.jpg`,datePublished:"2023-02-01",keywords:["piton","branding","app design"]},ux:{title:"UX — Product & UX Projects | Zack MacTavish",description:"Portfolio of UX and product design projects by Zack MacTavish.",url:`${l}/projects/ux`,image:`${l}/assets/Giga—mockup.jpg`,keywords:["ux","product design"]},"access-direct":{title:"Access Direct — UX & Brand | Zack MacTavish",description:"Case study: Access Direct — brand, UX and website built by Zack MacTavish.",url:`${l}/projects/access-direct`,image:`${l}/assets/AD—Macs.jpg`,datePublished:"2022-10-01",keywords:["access direct","ux","brand"]},"graphic-design":{title:"Graphic Design — Portfolio | Zack MacTavish",description:"Graphic design and art pieces by Zack MacTavish, including posters, packaging, and editorial work.",url:`${l}/projects/graphic-design`,image:`${l}/assets/Cover.png`,keywords:["graphic design","posters","packaging"]},threepillars:{title:"ThreePillars — UX & Branding | Zack MacTavish",description:"Case study: ThreePillars — brand and web app design by Zack MacTavish.",url:`${l}/projects/threepillars`,image:`${l}/assets/ThreePillars—Macbook.png`,keywords:["threepillars","branding","ux"]},microsoft:{title:"Microsoft — Project | Zack MacTavish",description:"Case study: Microsoft — UX and visual design work by Zack MacTavish. Password protected.",url:`${l}/projects/microsoft`,image:y.defaultImage,keywords:["microsoft","branding","ux","password protected"]}},Ue=r.div`
  display: grid;
...
`,f=({src:t,avif:a,webp:o,alt:m="",width:c="60vw",style:h={}})=>{typeof t=="string"&&t.split("/").pop().replace(/\.[^.]+$/,"");const u={width:c,maxWidth:"1000px",height:"auto",display:"block",borderRadius:"24px",boxShadow:"0 2px 12px 0 rgba(0,0,0,0.06)",...h};return e.jsxs("picture",{children:[a&&e.jsx("source",{srcSet:a,type:"image/avif"}),o&&e.jsx("source",{srcSet:o,type:"image/webp"}),e.jsx("style",{children:".single-image-responsive { @media (max-width: 1320px) { width: 90vw !important; max-width: 90vw !important; } @media (max-width: 850px) { width: 100vw !important; max-width: 100vw !important; border-radius: 0 !important; } }"}),e.jsx("img",{src:t,alt:m,className:"single-image-responsive",style:u,loading:"lazy",decoding:"async"})]})},b=r.div`
  display: flex;
  justify-content: center;
  background-color: ${t=>t.theme.backgroundTwo};
  align-items: center;
