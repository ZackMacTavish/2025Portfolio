const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Resume-BnQyFaBA.js","./three-D9NkSzoP.js","./vendor-D7aqownG.js","./index-OWNjQ_yi.js","./AD-CIQE0k_3.js","./Graphicdesign-LOF-kUVE.js","./Grid60-DIOAOb55.js","./LandingPage-Dq5LQ2B_.js","./LeysiApp—Screens copy-CsLIUfOG.js","./ThreePillars—pages-De3L89hY.js","./Group 55618@2x-DJ5DP13a.js","./BrandGuidelines—Mockup-KdAEjx2l.js","./Outsource-BbQtpjnF.js","./UX-CIbL334s.js","./ThreePillars-2s1QRuWH.js","./Piton-MetyChm4.js","./Microsoft-DDQzb-tZ.js","./IntroAnimation-C4VZDGJp.js"])))=>i.map(i=>d[i]);
import{j as e,_ as d,c as D}from"./three-D9NkSzoP.js";import{u as z,c as i,b as t,l as k,d as S,R as P,L as j,K as A,H as M,e as O,f as l,N as I}from"./vendor-D7aqownG.js";(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))u(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&u(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function u(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const v={fonts:{body:"Space Grotesk, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif",heading:"Space Grotesk, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif",mono:'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace'},fontSizes:{xs:"0.75rem",sm:"0.875rem",md:"1rem",lg:"1.125rem",xl:"1.25rem",h3:"1.15rem",h2:"clamp(1.4rem, 3vw, 2rem)",h1:"clamp(2rem, 6vw, 4.8rem)"},lineHeights:{tight:1.1,snug:1.2,normal:1.5,relaxed:1.7},spacing:{xs:"4px",sm:"8px",md:"12px",lg:"16px",xl:"24px","2xl":"32px","3xl":"48px"},radii:{none:"0",sm:"6px",md:"10px",lg:"16px",xl:"18px",pill:"999px",round:"50%",card:"18px"}},X={backgroundColor:"#3F4739",backgroundTwo:"#ffffff",fontColor:"#5D5D5D"},$={backgroundColor:"#303030",backgroundTwo:"#303030",fontColor:"#a1a1a1"},F={...v,...X},G={...v,...$},N=z`
    :root {
...
`,Z=i.span`
  ...
  animation: ${L} 10s ease-in-out forwards;
  z-index: 998;
`,ee=i.span`
  position: absolute;
  bottom: 0;
...
`;i.div`
  ...
  margin: 0.25rem 0;
`;function le(){const[o,c]=t.useState(!1),s=S(),u=P.useRef();t.useEffect(()=>{c(!1)},[s.pathname]),t.useEffect(()=>{if(!o||!window.matchMedia("(hover: none) and (pointer: coarse)").matches)return;const a=()=>c(!1),m=x=>{u.current&&!u.current.contains(x.target)&&c(!1)};return window.addEventListener("scroll",a,{passive:!0}),document.addEventListener("mousedown",m),document.addEventListener("touchstart",m),()=>{window.removeEventListener("scroll",a),document.removeEventListener("mousedown",m),document.removeEventListener("touchstart",m)}},[o]);const n=()=>c(a=>!a),r=()=>c(!1);return e.jsxs(J,{children:[e.jsx(j,{to:"/MacTavish",style:{cursor:"none"},children:e.jsx(oe,{src:W})}),e.jsxs(ne,{children:[e.jsxs(se,{children:[e.jsxs(T,{children:[e.jsx(ae,{role:"presentation","aria-haspopup":"true","aria-expanded":o,style:{cursor:"default"},onClick:a=>{window.matchMedia("(hover: none)").matches?n():a.preventDefault()},children:"Projects"}),e.jsx("div",{style:{position:"absolute",left:"-20px",top:"calc(100% - 40px)",width:"120px",height:"75px",background:"rgba(255,0,0,0.0)",border:"none",pointerEvents:window.matchMedia&&window.matchMedia("(hover: none) and (pointer: coarse)").matches?"none":"auto",zIndex:1100}}),e.jsxs(ce,{$open:o,ref:u,children:[e.jsx(g,{to:"/Microsoft",onClick:r,children:"Microsoft"}),e.jsx(g,{to:"/Outsource",onClick:r,children:"Outsource"}),e.jsx(g,{to:"/Ux",onClick:r,children:"Leysi"}),e.jsx(g,{to:"/Piton",onClick:r,children:"Piton"}),e.jsx(g,{to:"/ThreePillars",onClick:r,children:"Three Pillars"}),e.jsx(g,{to:"/AccessDirect",onClick:r,children:"Access Direct"}),e.jsx(g,{to:"/Giga",onClick:r,children:"Giga"}),e.jsx(g,{to:"/GraphicDesign",onClick:r,children:"Graphic Design"})]})]}),e.jsx(T,{children:e.jsx(ie,{to:"/Resume",children:"Resume"})})]}),e.jsxs(Q,{children:[e.jsx(Z,{}),e.jsx(ee,{}),e.jsx(re,{}),e.jsx(K,{}),e.jsx(q,{})]})]})]})}const de=t.lazy(()=>d(()=>import("./Resume-BnQyFaBA.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)),ue=t.lazy(()=>d(()=>import("./AD-CIQE0k_3.js").then(o=>o.A),__vite__mapDeps([4,1,2,3]),import.meta.url)),pe=t.lazy(()=>d(()=>import("./AD-CIQE0k_3.js").then(o=>o.G),__vite__mapDeps([4,1,2,3]),import.meta.url)),me=t.lazy(()=>d(()=>import("./Graphicdesign-LOF-kUVE.js"),__vite__mapDeps([5,1,2,4,3,6]),import.meta.url)),he=t.lazy(()=>d(()=>import("./LandingPage-Dq5LQ2B_.js"),__vite__mapDeps([7,1,2,4,3,6,8,9,10,11]),import.meta.url)),xe=t.lazy(()=>d(()=>import("./Outsource-BbQtpjnF.js"),__vite__mapDeps([12,1,2,4,3,11]),import.meta.url)),ge=t.lazy(()=>d(()=>import("./UX-CIbL334s.js"),__vite__mapDeps([13,1,2,4,3,8]),import.meta.url)),fe=t.lazy(()=>d(()=>import("./ThreePillars-2s1QRuWH.js"),__vite__mapDeps([14,1,2,4,3,9]),import.meta.url)),be=t.lazy(()=>d(()=>import("./Piton-MetyChm4.js"),__vite__mapDeps([15,1,2,10,4,3,13,8]),import.meta.url)),ve=t.lazy(()=>d(()=>import("./Microsoft-DDQzb-tZ.js"),__vite__mapDeps([16,1,2,4,3]),import.meta.url)),ye=t.lazy(()=>d(()=>import("./IntroAnimation-C4VZDGJp.js"),__vite__mapDeps([17,1,2,7,4,3,6,8,9,10,11]),import.meta.url));function ke(){const[o,c]=t.useState("light");return e.jsxs(A,{theme:o==="light"?F:G,children:[e.jsx(N,{}),e.jsxs("div",{className:"App",children:[e.jsxs(M,{children:[e.jsx(H,{}),e.jsx(le,{}),e.jsx(t.Suspense,{fallback:e.jsx("div",{style:{color:"#888",padding:"2rem",textAlign:"center"},children:"Loading…"}),children:e.jsxs(O,{children:[e.jsx(l,{path:"/",element:e.jsx(ye,{})}),e.jsx(l,{path:"/MacTavish",element:e.jsx(he,{})}),e.jsx(l,{path:"/Giga",element:e.jsx(pe,{})}),e.jsx(l,{path:"/AccessDirect",element:e.jsx(ue,{})}),e.jsx(l,{path:"/Outsource",element:e.jsx(xe,{})}),e.jsx(l,{path:"/GraphicDesign",element:e.jsx(me,{})}),e.jsx(l,{path:"/Ux",element:e.jsx(ge,{})}),e.jsx(l,{path:"/ThreePillars",element:e.jsx(fe,{})}),e.jsx(l,{path:"/Piton",element:e.jsx(be,{})}),e.jsx(l,{path:"/Microsoft",element:e.jsx(ve,{})}),e.jsx(l,{path:"/Resume",element:e.jsx(de,{})}),e.jsx(l,{path:"*",element:e.jsx(I,{to:"/",replace:!0})})]})})]}),!1]})]})}D.createRoot(document.getElementById("root")).render(e.jsx(t.StrictMode,{children:e.jsx(ke,{})}));
