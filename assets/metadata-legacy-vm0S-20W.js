System.register(["./vendor-legacy-BmQ_CjD0.js"],function(e,t){"use strict";var i,o,a;return{setters:[e=>{i=e.b,o=e.c,a=e.u}],execute:function(){e("A",function(e){const{imageSrc:t,imageAvif:i,imageWebp:o,imageAlt:a,mobileSrc:r,mobileAvif:s,mobileWebp:n,width:l,className:h,textSize:y,textColor:f,children:x,...b}=e,w=function e(t){if(!t||"object"!=typeof t)return t;if(Array.isArray(t))return t.map(e);const i={};for(const o in t){if("mobileSrc"===o||"mobileAvif"===o||"mobileWebp"===o)continue;const a=t[o];i[o]="object"==typeof a&&null!==a?e(a):a}return i}(b),v=g(t),k=g(i),$=g(o),C=g(r),M=g(s),A=g(n);return c.jsxs(d,{$width:l,className:h,...w,children:[c.jsx(u,{children:c.jsxs("picture",{children:[M&&c.jsx("source",{srcSet:M,type:"image/avif",media:"(max-width: 700px)"}),A&&c.jsx("source",{srcSet:A,type:"image/webp",media:"(max-width: 700px)"}),C&&c.jsx("source",{srcSet:C,media:"(max-width: 700px)"}),k&&c.jsx("source",{srcSet:k,type:"image/avif"}),$&&c.jsx("source",{srcSet:$,type:"image/webp"}),c.jsx(m,{src:v,alt:a})]})}),c.jsx(p,{$textSize:y,$textColor:f,children:x})]})}),e("E",({title:e,description:t,url:o,image:a,images:r=null,type:s="website",authorName:n="Zack MacTavish",authorAlternateNames:c=["Zachary MacTavish"],sameAs:l=[],keywords:d=[],jsonLd:u=null,favicons:m=null,siteDefaults:p=null,siteName:g=null,locale:h=null,robots:y=null,themeColor:f=null,twitterSite:x=null,twitterCreator:b=null})=>(i.useEffect(()=>{e&&(document.title=e);const i=(e,t,i)=>{let o=document.querySelector(e);if(!o){o=document.createElement("meta");const t=e.match(/\[(name|property)=['"]([^'"]+)['"]\]/);t&&o.setAttribute(t[1],t[2]),document.head.appendChild(o)}o.setAttribute(t,i)};t&&(i("[name='description']","content",t),i("[property='og:description']","content",t),i("[name='twitter:description']","content",t)),d&&d.length&&i("[name='keywords']","content",Array.isArray(d)?d.join(", "):d),e&&(i("[property='og:title']","content",e),i("[name='twitter:title']","content",e)),i("[property='og:type']","content",s),o&&i("[property='og:url']","content",o);const w=g||p&&p.siteName||null,v=h||p&&p.locale||null,k=y||p&&p.robots||null,$=f||p&&p.themeColor||null,C=x||p&&p.twitterSite||null,M=b||p&&p.twitterCreator||null;w&&i("[property='og:site_name']","content",w),v&&i("[property='og:locale']","content",v),k&&i("[name='robots']","content",k),$&&i("[name='theme-color']","content",$),C&&i("[name='twitter:site']","content",C),M&&i("[name='twitter:creator']","content",M);const A=p&&p.ogImages||[],j=r||(a?[a]:null)||A,T=e=>{document.querySelectorAll(e).forEach(e=>e.remove())};T("meta[property='og:image']"),T("meta[property='og:image:width']"),T("meta[property='og:image:height']");let S=null;if(j&&j.length?j.forEach(e=>{let t=e;if("string"==typeof e&&(t={url:e}),!t||!t.url)return;const i=document.createElement("meta");if(i.setAttribute("property","og:image"),i.setAttribute("content",t.url),document.head.appendChild(i),t.width){const e=document.createElement("meta");e.setAttribute("property","og:image:width"),e.setAttribute("content",String(t.width)),document.head.appendChild(e)}if(t.height){const e=document.createElement("meta");e.setAttribute("property","og:image:height"),e.setAttribute("content",String(t.height)),document.head.appendChild(e)}S||(S=t.url)}):a&&(i("[property='og:image']","content",a),S=a),S?(i("[name='twitter:image']","content",S),i("[name='twitter:card']","content","summary_large_image")):i("[name='twitter:card']","content","summary"),o){let e=document.querySelector("link[rel='canonical']");e||(e=document.createElement("link"),e.setAttribute("rel","canonical"),document.head.appendChild(e)),e.setAttribute("href",o)}const Z="seo-json-ld";let U=document.getElementById(Z);const I={"@context":"https://schema.org","@type":"Person",name:n,url:o||window.location.href};c&&c.length&&(I.alternateName=1===c.length?c[0]:c),l&&l.length&&(I.sameAs=l);let P=u||I;if(u)try{const e=u;("CreativeWork"===e["@type"]||"Article"===e["@type"])&&!e.author&&(e.author={"@type":"Person",name:n,url:o||window.location.href},c&&c.length&&(e.author.alternateName=1===c.length?c[0]:c),l&&l.length&&(e.author.sameAs=l)),P=e}catch{P=u}else P=I;U?U.text=JSON.stringify(P):(U=document.createElement("script"),U.id=Z,U.type="application/ld+json",U.text=JSON.stringify(P),document.head.appendChild(U)),(n||c&&c.length)&&i("[name='author']","content",[n].concat(c||[]).filter(Boolean).join(", ")),l&&l.length&&i("[name='sameAs']","content",l.join(", "));const z=m||p&&p.favicons||null,E=e=>{document.querySelectorAll(`link[rel='${e}']`).forEach(e=>e.remove())};E("icon"),E("shortcut icon"),E("apple-touch-icon"),E("manifest"),z&&(Array.isArray(z)?z.forEach(e=>{const t=document.createElement("link");e.rel?t.setAttribute("rel",e.rel):t.setAttribute("rel","180x180"===e.sizes?"apple-touch-icon":"icon"),e.sizes&&t.setAttribute("sizes",e.sizes),t.setAttribute("href",e.href),document.head.appendChild(t)}):Object.entries(z).forEach(([e,t])=>{const i=document.createElement("link");"180x180"===e?i.setAttribute("rel","apple-touch-icon"):i.setAttribute("rel","icon"),i.setAttribute("sizes",e),i.setAttribute("href",t),document.head.appendChild(i)}))},[e,t,o,a,s,n,c,l,d,u,m,p,g,h,y,f,x,b]),null));var t,r,s={exports:{}},n={},c=(r||(r=1,s.exports=function(){if(t)return n;t=1;var e=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function o(t,i,o){var a=null;if(void 0!==o&&(a=""+o),void 0!==i.key&&(a=""+i.key),"key"in i)for(var r in o={},i)"key"!==r&&(o[r]=i[r]);else o=i;return i=o.ref,{$$typeof:e,type:t,key:a,ref:void 0!==i?i:null,props:o}}return n.Fragment=i,n.jsx=o,n.jsxs=o,n}()),s.exports);a`
