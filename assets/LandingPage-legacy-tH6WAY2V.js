...
`,ti=a.div`
  width: 24px;
  height: 24px;
  border-left: 3px solid ${e=>e.theme.onOlive};
  border-bottom: 3px solid ${e=>e.theme.onOlive};
  transform: rotate(-45deg);
  border-radius: 2px;
