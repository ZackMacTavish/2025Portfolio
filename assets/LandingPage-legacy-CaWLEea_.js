...
`,Wt=n.p`
  ...
  line-height: 1.65;
`,Ft=(e,t,i)=>{if(e<=t[0])return i[0];if(e>=t[t.length-1])return i[i.length-1];const r=t.findIndex(t=>t>=e)-1,a=(e-t[r])/(t[r+1]-t[r]);return i[r]+(i[r+1]-i[r])*a},Rt=({step:e,progress:t,reduceMotion:r})=>{const a=Ft(t,e.range,[0,1,1,0]),n=r?0:Ft(t,e.range,[72,0,0,-72]),o=r?1:Ft(t,e.range,[.96,1,1,1.025]),s=r?0:Ft(t,e.range,[14,0,0,14]);return i.jsx(xt,{style:{opacity:a,filter:`blur(${s}px)`,transform:`translateY(${n}px) scale(${o})`},children:i.jsxs(vt,{children:[i.jsx(yt,{children:e.eyebrow}),i.jsx(kt,{children:e.title}),i.jsx(jt,{children:e.body})]})})},Zt=()=>{const e=a.useRef(null),[t,r]=a.useState(0),n=L(),{scrollYProgress:o}=fe({target:e,offset:["start start","end end"]});var s,l,A;s=o,l="change",A=r,a.useInsertionEffect(()=>s.on(l,A),[s,l,A]);const d=Ft(t,[0,.78,.88],[0,0,1]),m=Ft(t,[0,.74,.755],[.2,.2,0]),c=Ft(t,[0,.74,.755],[1,1,0]),h=Math.round(255*d),p=Math.round(255-238*d);return i.jsxs(ht,{children:[i.jsx(pt,{ref:e,children:i.jsxs(gt,{style:{backgroundColor:`rgb(${h}, ${h}, ${h})`,color:`rgb(${p}, ${p}, ${p})`},children:[mt.map(e=>i.jsx(Rt,{step:e,progress:t,reduceMotion:n},e.title)),i.jsx(ft,{"aria-hidden":"true",style:{opacity:m},children:i.jsx(ut,{style:{transform:`scaleX(${t})`}})}),i.jsxs(bt,{"aria-hidden":"true",style:{opacity:c},children:[i.jsx(T,{}),i.jsx("span",{children:"Scroll"})]})]})}),i.jsx(Ct,{"aria-labelledby":"faq-heading",children:i.jsxs(Bt,{children:[i.jsx(Et,{id:"faq-heading",children:"Frequently asked questions"}),i.jsx(Mt,{children:ct.map(e=>i.jsxs(zt,{children:[i.jsxs(Lt,{"data-cursor":"link",children:[i.jsx("span",{children:e.question}),i.jsx(I,{"aria-hidden":"true"})]}),i.jsx(Wt,{children:e.answer})]},e.question))})]})})]})},Ut=a.lazy(()=>r(()=>t.import("./three-legacy-CcKZTcak.js"),void 0,t.meta.url)),Dt=({desktop:e,desktopAvif:t,desktopWebp:r,mobile600:a,mobile900:n,mobile600Avif:o,mobile900Avif:s,mobile600Webp:l,mobile900Webp:A,alt:d})=>i.jsxs("picture",{children:[i.jsx("source",{srcSet:o,type:"image/avif",media:"(max-width: 650px)"}),i.jsx("source",{srcSet:s,type:"image/avif",media:"(max-width: 900px)"}),i.jsx("source",{srcSet:t,type:"image/avif"}),i.jsx("source",{srcSet:l,type:"image/webp",media:"(max-width: 650px)"}),i.jsx("source",{srcSet:A,type:"image/webp",media:"(max-width: 900px)"}),i.jsx("source",{srcSet:r,type:"image/webp"}),i.jsx("source",{srcSet:a,type:"image/jpeg",media:"(max-width: 650px)"}),i.jsx("source",{srcSet:n,type:"image/jpeg",media:"(max-width: 900px)"}),i.jsx("img",{src:e,alt:d,style:{width:"100%",height:"100%",objectFit:"cover"},loading:"lazy"})]}),Tt=n(R)`
...
`,Qt=n.div`
  ...
  &::after {
    top: 40%;
    left: 65%;
    animation: ${Yt} 40s ease-in-out infinite;
  }
...
`,qt=e=>i.jsx(Fe,{desktop:ue,desktopAvif:we,desktopWebp:be,mobile600:xe,mobile900:ve,mobile600Avif:ye,mobile900Avif:ke,mobile600Webp:je,mobile900Webp:Ce,alt:"Zack MacTavish portrait",loading:"eager",decoding:"async",fetchPriority:"high",className:"about-picture-img",style:e.style}),Pt=n.div`
  display: flex;
  position: relative;
  z-index: 1;
...
`,Kt=n.div`
  animation: ${Gt} 1.5s infinite ease-in-out; /* animate only Y so X-centering stays intact */
...
`,ai=n.div.attrs({"data-cursor":"link",role:"link"})`
  display: flex;
  flex-direction: column;
  gap: 6px;
...
`,hi=n.img.attrs({loading:"lazy",decoding:"async"})`
  width: 100%;
  height: auto;
