...
`;function T({src:e,alt:t,avif:n,webp:a,aspectRatio:o,parallaxSpeed:l=0,className:d,borderRadius:p="12px",objectFit:f="cover",objectPosition:u="center",imageScale:g=1,disableRevealAnimation:R=!1,loading:v="lazy",decoding:C="async",onLoad:W}){const F=x.useRef(null),S=nt(),[B,O]=x.useState(window.innerWidth<768);x.useEffect(()=>{const j=()=>{O(window.innerWidth<768)};return window.addEventListener("resize",j),()=>window.removeEventListener("resize",j)},[]);const{scrollYProgress:N}=zt({target:F,offset:["start end","end start"]}),E=Math.max(0,l)*60,A=_e(N,[0,1],[-E,E]),y=l>0&&!S&&!B;return i.jsx(Ht,{ref:F,className:d,$aspectRatio:o,$borderRadius:p,...R?{}:{initial:{opacity:0,y:24},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.9,ease:[.25,.1,.25,1]}},children:i.jsxs(Mt,{children:[n&&i.jsx("source",{srcSet:n,type:"image/avif"}),a&&i.jsx("source",{srcSet:a,type:"image/webp"}),i.jsx(Wt,{src:e,alt:t,loading:v,decoding:C,onLoad:W,style:{y:y?A:0,scale:g},$objectFit:f,$objectPosition:u,$hasParallax:y})]})})}const Bt=s.div`
  width: 100%;
