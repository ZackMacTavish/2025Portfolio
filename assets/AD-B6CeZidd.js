import{j as t}from"./three-D9NkSzoP.js";import{b as H,c as n,u as fe,R as L}from"./vendor-D7aqownG.js";const xe=({title:e,description:i,url:r,image:a,images:s=null,type:d="website",authorName:u="Zack MacTavish",authorAlternateNames:c=["Zachary MacTavish"],sameAs:m=[],keywords:j=[],jsonLd:k=null,favicons:W=null,siteDefaults:g=null,siteName:V=null,locale:Y=null,robots:ee=null,themeColor:te=null,twitterSite:ie=null,twitterCreator:re=null})=>(H.useEffect(()=>{e&&(document.title=e);const h=(o,l,v)=>{let f=document.querySelector(o);if(!f){f=document.createElement("meta");const N=o.match(/\[(name|property)=['"]([^'"]+)['"]\]/);N&&f.setAttribute(N[1],N[2]),document.head.appendChild(f)}f.setAttribute(l,v)};i&&(h("[name='description']","content",i),h("[property='og:description']","content",i),h("[name='twitter:description']","content",i)),j&&j.length&&h("[name='keywords']","content",Array.isArray(j)?j.join(", "):j),e&&(h("[property='og:title']","content",e),h("[name='twitter:title']","content",e)),h("[property='og:type']","content",d),r&&h("[property='og:url']","content",r);const ae=V||g&&g.siteName||null,oe=Y||g&&g.locale||null,ne=ee||g&&g.robots||null,se=te||g&&g.themeColor||null,ce=ie||g&&g.twitterSite||null,de=re||g&&g.twitterCreator||null;ae&&h("[property='og:site_name']","content",ae),oe&&h("[property='og:locale']","content",oe),ne&&h("[name='robots']","content",ne),se&&h("[name='theme-color']","content",se),ce&&h("[name='twitter:site']","content",ce),de&&h("[name='twitter:creator']","content",de);const Re=g&&g.ogImages||[],Z=s||(a?[a]:null)||Re,F=o=>{document.querySelectorAll(o).forEach(l=>l.remove())};F("meta[property='og:image']"),F("meta[property='og:image:width']"),F("meta[property='og:image:height']");let D=null;if(Z&&Z.length?Z.forEach(o=>{let l=o;if(typeof o=="string"&&(l={url:o}),!l||!l.url)return;const v=document.createElement("meta");if(v.setAttribute("property","og:image"),v.setAttribute("content",l.url),document.head.appendChild(v),l.width){const f=document.createElement("meta");f.setAttribute("property","og:image:width"),f.setAttribute("content",String(l.width)),document.head.appendChild(f)}if(l.height){const f=document.createElement("meta");f.setAttribute("property","og:image:height"),f.setAttribute("content",String(l.height)),document.head.appendChild(f)}D||(D=l.url)}):a&&(h("[property='og:image']","content",a),D=a),D?(h("[name='twitter:image']","content",D),h("[name='twitter:card']","content","summary_large_image")):h("[name='twitter:card']","content","summary"),r){let o=document.querySelector("link[rel='canonical']");o||(o=document.createElement("link"),o.setAttribute("rel","canonical"),document.head.appendChild(o)),o.setAttribute("href",r)}const le="seo-json-ld";let C=document.getElementById(le);const G={"@context":"https://schema.org","@type":"Person",name:u,url:r||window.location.href};c&&c.length&&(G.alternateName=c.length===1?c[0]:c),m&&m.length&&(G.sameAs=m);let $=k||G;if(!k)$=G;else try{const o=k;(o["@type"]==="CreativeWork"||o["@type"]==="Article")&&!o.author&&(o.author={"@type":"Person",name:u,url:r||window.location.href},c&&c.length&&(o.author.alternateName=c.length===1?c[0]:c),m&&m.length&&(o.author.sameAs=m)),$=o}catch{$=k}if(C?C.text=JSON.stringify($):(C=document.createElement("script"),C.id=le,C.type="application/ld+json",C.text=JSON.stringify($),document.head.appendChild(C)),u||c&&c.length){const o=[u].concat(c||[]).filter(Boolean).join(", ");h("[name='author']","content",o)}m&&m.length&&h("[name='sameAs']","content",m.join(", "));const E=W||g&&g.favicons||null,B=o=>{document.querySelectorAll(`link[rel='${o}']`).forEach(l=>l.remove())};B("icon"),B("shortcut icon"),B("apple-touch-icon"),B("manifest"),E&&(Array.isArray(E)?E.forEach(o=>{const l=document.createElement("link");o.rel?l.setAttribute("rel",o.rel):l.setAttribute("rel",o.sizes==="180x180"?"apple-touch-icon":"icon"),o.sizes&&l.setAttribute("sizes",o.sizes),l.setAttribute("href",o.href),document.head.appendChild(l)}):Object.entries(E).forEach(([o,l])=>{const v=document.createElement("link");o==="180x180"?v.setAttribute("rel","apple-touch-icon"):v.setAttribute("rel","icon"),v.setAttribute("sizes",o),v.setAttribute("href",l),document.head.appendChild(v)}))},[e,i,r,a,d,u,c,m,j,k,W,g,V,Y,ee,te,ie,re]),null);var me={exports:{}},z={},he;function Pe(){if(he)return z;he=1;var e=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function r(a,s,d){var u=null;if(d!==void 0&&(u=""+d),s.key!==void 0&&(u=""+s.key),"key"in s){d={};for(var c in s)c!=="key"&&(d[c]=s[c])}else d=s;return s=d.ref,{$$typeof:e,type:a,key:u,ref:s!==void 0?s:null,props:d}}return z.Fragment=i,z.jsx=r,z.jsxs=r,z}var pe;function Ce(){return pe||(pe=1,me.exports=Pe()),me.exports}var U=Ce();fe`
...
`,jt=n.img.attrs({loading:"lazy",decoding:"async"})`
width: 60vw;
...
`;function Lt(){return H.useLayoutEffect(()=>{window.scrollTo(0,0)}),t.jsxs(K,{children:[t.jsx(xe,{...w.giga,sameAs:y.sameAs,keywords:w.giga.keywords,jsonLd:{"@context":"https://schema.org","@type":"CreativeWork",headline:w.giga.title,description:w.giga.description,image:w.giga.image,author:{"@type":"Person",name:y.name,url:`${y.url}/about`},url:w.giga.url,datePublished:w.giga.datePublished,keywords:w.giga.keywords}}),t.jsx(je,{title:"Giga",imageBaseName:"assets/Giga—Macbookv2",imageExt:"png",imageAlt:"Giga Macbook Mockup",imageWidth:"38vw",buttons:[{href:"https://gigaintelligence.com",label:"Visit Giga"}]}),t.jsx(q,{children:t.jsxs(J,{children:[t.jsxs(A,{children:[t.jsx(R,{children:"Project Type"}),t.jsx(P,{children:"UX/UI, Branding, Strategy"})]}),t.jsxs(A,{children:[t.jsx(R,{children:"Digital Product"}),t.jsx(P,{children:"Digital strategy platform used for data management, and private channel creation"})]}),t.jsxs(A,{children:[t.jsx(R,{children:"My Role"}),t.jsx(P,{children:"Responsible for researching, ideating, and generating ideas for a cohesive Giga experience. Designed and prototyped the Giga system & Web App"})]}),t.jsxs(A,{children:[t.jsx(R,{children:"Timeframe"}),t.jsx(P,{children:"1 1/2 years"})]})]})}),t.jsx(S,{src:Ne,webp:Xe,fallback:He,style:{width:"100vw",maxWidth:"100vw",height:"auto",objectFit:"cover",display:"block",margin:0,padding:0,borderRadius:0}}),t.jsx(O,{style:{backgroundColor:"#ffffff"},children:t.jsx(T,{children:t.jsx(M,{style:{color:"#5D5D5D"},children:"Giga is a startup focused on sharing experiences between its users. Through a robust data management system, users can share information and learn about their favorite subjects"})})}),t.jsx(S,{src:qe}),t.jsx(b,{children:t.jsx(x,{src:Je,avif:Ke,webp:Qe})}),t.jsx(b,{children:t.jsx(x,{src:ft,avif:xt,webp:bt})}),t.jsx(S,{src:Ve}),t.jsx(b,{children:t.jsx(x,{src:Ye,avif:et,webp:tt})}),t.jsx(Q,{srcLeft:it,avifLeft:rt,webpLeft:at,srcRight:ot,avifRight:nt,webpRight:st}),t.jsx(b,{children:t.jsx(x,{src:ct,avif:dt,webp:lt})}),t.jsx(b,{style:{paddingBottom:"7vh"},children:t.jsxs("div",{style:{width:"100%",display:"flex",justifyContent:"center"},children:[t.jsx(x,{src:mt,avif:ht,webp:pt,style:{width:"60vw",maxWidth:"420px",minHeight:"auto",height:"auto",borderRadius:24,boxShadow:"0 2px 12px 0 rgba(0,0,0,0.06)"}}),t.jsx("style",{children:`
      @media (max-width: 850px) {
        .about-me-img {
