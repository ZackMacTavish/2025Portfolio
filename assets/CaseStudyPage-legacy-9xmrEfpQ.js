...
`,H=.18;function O(e){const i=e.trim();if(i.includes("/")){const[e,t]=i.split("/").map(e=>parseFloat(e));if(e&&t)return e/t}const t=parseFloat(i);return Number.isFinite(t)&&t>0?t:16/9}function Y({id:e,className:n,children:o,overlayContent:d,ariaLabel:s="Open image in full-screen viewer",aspectRatio:l="16/9"}){const[c,g]=r.useState(!1),[p,u]=r.useState(!1),x=r.useRef(null),f=m(),b=i(1),w=i(0),v=i(0);r.useEffect(()=>{u(!0)},[]);const j=r.useCallback(()=>{const e=O(l);if(e>=.75||"undefined"==typeof window)return 0;const i=Math.min(.9*window.innerWidth,1400)/e,t=Math.min(Math.max(16,.04*window.innerWidth),48),r=window.innerHeight-2*t;return Math.max(0,(i-r)/2)},[l]),y=r.useCallback(()=>{b.set(1),w.set(0),v.set(j())},[b,w,v,j]),$=r.useCallback(()=>{b.set(1),w.set(0),v.set(j()),g(!0)},[b,w,v,j]),k=r.useCallback(()=>{g(!1)},[]);r.useEffect(()=>{if(!c||"undefined"==typeof document)return;const e=document.body.style.overflow;document.body.style.overflow="hidden";const i=e=>{if("Escape"===e.key&&k(),"+"!==e.key&&"="!==e.key||b.set(Math.min(5,b.get()+H)),"-"===e.key||"_"===e.key){const e=Math.max(1,b.get()-H);b.set(e),1===e&&(w.set(0),v.set(j()))}"0"===e.key&&y()};return window.addEventListener("keydown",i),()=>{var t;document.body.style.overflow=e,window.removeEventListener("keydown",i),null===(t=x.current)||void 0===t||t.focus()}},[c,k,b,w,v,y]);const C={x:w,y:v,scale:b},R=null!=d?d:o;return t.jsxs(t.Fragment,{children:[t.jsxs(F,{ref:x,type:"button",layoutId:`zoomable-${e}`,className:n,onClick:$,"aria-label":s,style:{visibility:c?"hidden":"visible"},children:[o,t.jsxs(M,{"aria-hidden":"true",children:[t.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("circle",{cx:"11",cy:"11",r:"7"}),t.jsx("line",{x1:"20",y1:"20",x2:"16.65",y2:"16.65"}),t.jsx("line",{x1:"11",y1:"8",x2:"11",y2:"14"}),t.jsx("line",{x1:"8",y1:"11",x2:"14",y2:"11"})]}),"Click to zoom"]})]}),p&&a.createPortal(t.jsx(h,{children:c&&t.jsxs(T,{role:"dialog","aria-modal":"true",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:f?0:.25},onClick:k,children:[t.jsx(E,{type:"button","aria-label":"Close image viewer",onClick:e=>{e.stopPropagation(),k()},children:"×"}),t.jsx(A,{onClick:e=>e.stopPropagation(),onWheel:e=>{e.preventDefault();const i=(e.deltaY>0?-1:1)*H,t=Math.min(5,Math.max(1,b.get()+i));b.set(t),1===t&&(w.set(0),v.set(j()))},children:t.jsx(V,{$ratio:O(l),layoutId:f?void 0:`zoomable-${e}`,style:C,drag:!0,dragMomentum:!1,dragElastic:.08,onDragEnd:()=>{!(O(l)<.75)&&b.get()<=1.001&&(w.set(0),v.set(0))},onDoubleClick:()=>{b.get()>1?y():b.set(2)},transition:{type:"spring",stiffness:260,damping:28},children:R})}),t.jsxs(L,{onClick:e=>e.stopPropagation(),children:[t.jsx(W,{type:"button","aria-label":"Zoom out",onClick:()=>{const e=Math.max(1,b.get()-H);b.set(e),1===e&&(w.set(0),v.set(j()))},children:"−"}),t.jsx(W,{type:"button","aria-label":"Reset zoom",onClick:y,children:"⤢"}),t.jsx(W,{type:"button","aria-label":"Zoom in",onClick:()=>{b.set(Math.min(5,b.get()+H))},children:"+"}),t.jsx(D,{}),t.jsx(N,{children:"Scroll to zoom · drag to pan · double-click to reset · Esc to close"})]})]},"zoomable-backdrop")}),document.body)]})}function q({children:e}){const i=r.Children.toArray(e);if(1!==i.length||"string"!=typeof i[0])return t.jsx(t.Fragment,{children:e});const n=i[0],o=n.trim().split(/\s+/);if(o.length<2)return t.jsx(t.Fragment,{children:n});const a=o.pop(),d=o.pop(),s=o.join(" ");return t.jsxs(t.Fragment,{children:[s,s?" ":"",d," ",a]})}const U=new Set(["white","#fff","#ffffff","#fafafa","#f9fafb","#f5f5f5","#f6f8fc","#f0efeb","#e7e7e7","#eeeeee","#eee"]),G=(e,i)=>e?"dark"!==i.name?e:U.has(e.toLowerCase())?i.surface:e:e,X=n.div`
  min-height: 100vh;
