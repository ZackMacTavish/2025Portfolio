...
export const projects = {
  ...
  outsource: {
    title: 'Outsource — Branding, UX/UI & Motion | Zack MacTavish',
    description:
      'Case study: Eighteen months as Multimedia Designer rebuilding a NYC permit expediting firm — parent brand, websites, internal project-tracking tool, and three subsidiary identities (CEU, BuildingOwl, OSINYC).',
